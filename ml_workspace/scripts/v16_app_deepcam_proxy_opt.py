...
def patch_dataset(system, adapter):
    ...
    def system_getitem(self, idx):
        ...
        if adapter is not None:
            ...
            # Exact sizes for DeepCAM: 
            # data: (768, 1152, 16) float32 -> 768*1152*16*4 = 56,623,104 bytes
            # label: (768, 1152) int64 -> 768*1152*8 = 7,077,888 bytes
            ...
            # Read-Through Caching: If not in cache, read from SSD and PUT to cache
            ...
            if payload is not None and len(payload) > DATA_SIZE:
                ...
                # Convert to numpy arrays without copying (Zero-copy view)
...
if __name__ == "__main__":
    ...
    # Cascade backward compatibility flag
    ...
    if args.system == 'cascade':
        ...
        class MLProxyAdapter(CascadeAdapter):
            def initialize(self):
                ...
                cfg.dedup_enabled = False # OPTIMIZATION
