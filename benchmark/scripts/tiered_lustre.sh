...
#SBATCH -o /pscratch/sd/s/sgkim/kcj/Cascade-kcj/benchmark/logs/tiered_lustre_%j.out
#SBATCH -e /pscratch/sd/s/sgkim/kcj/Cascade-kcj/benchmark/logs/tiered_lustre_%j.err
...
output_path = f"/pscratch/sd/s/sgkim/kcj/Cascade-kcj/benchmark/results/tiered_lustre_{job_id}.json"
