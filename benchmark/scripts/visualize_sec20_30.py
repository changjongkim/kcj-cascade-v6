...
def fig_sec20():
    ...
    weak_ttft = {
        "Cascade":       [12.3,38.3,37.2,55.4,53.7,49.9,65.0],
        ...
        "HDF5-Indep":    [80.0,243.9,270.1,189.4,194.1,204.6,204.8],
    }
    weak_tput = {
        "Cascade":       [74.2,51.7,104.1,141.9,293.6,640.5,980.1],
        ...
        "HDF5-Indep":    [12.5,8.2,14.8,42.2,82.4,156.4,312.5],
    }
    strong_ttft = {
        "Cascade":       [13.0,33.8,33.1,32.5,37.9,46.4,None],
        ...
        "HDF5-Indep":    [77.0,275.9,260.6,271.8,240.9,188.3,187.2],
    }
    strong_tput = {
        "Cascade":       [75.9,59.1,120.6,244.2,419.8,685.2,None],
        ...
        "HDF5-Indep":    [13.0,7.2,15.3,29.4,66.4,169.9,341.8],
    }
