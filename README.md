...
| System | 1N | 2N | 4N | 8N | 16N | 32N | 64N |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Cascade V13 🔥** | **10.0 / 99.6** | **36.8 / 74.6** | **34.5 / 116.0** | **43.0 / 194.5** | **46.4 / 340.3** | **73.2 / 477.5** | **88.9 / 745.1** |
...
| System | 1N | 2N | 4N | 8N | 16N | 32N | 64N |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Cascade V13 🔥** | **20.9 / 47.7** | **118.7 / 19.5** | **86.2 / 48.6** | **98.8 / 89.5** | **97.2 / 171.0** | **92.9 / 356.6** | **101.7 / 676.1** |
...
| System | 1N | 2N | 4N | 8N | 16N | 32N | 64N |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Cascade V13 🔥** | **26.1 / 38.3** | **101.6 / 17.1** | **87.6 / 51.9** | **74.0 / 108.1** | **123.2 / 142.6** | **134.6 / 257.5** | **185.8 / 364.3** |
...
| **32-Node** | **33.1s** | **18.3s** | **21.4s** | **21.7s** | **TBD** | **66.5s** | **23.1s** |
| **64-Node** | **13.7s** | **14.1s** | **15.9s** | **49.0s** | **Timeout** | **52.4s** | **Error** |
...
> 4. **Scaling Frontiers (32-64 Nodes)**: At 64 nodes, traditional file-system/caching baselines maintained high throughput (HDF5: 13.7s, LLM-GPU: 14.1s, LMCache-Disk: 15.9s). Conversely, Cascade Optimized (No-Dedup) processed the epoch in **52.4s**. The Original mode with global deduplication encountered a timeout at this massive scale due to synchronous lock contention. Cascade Streaming Mode encountered an `IndexError` during validation dataset loading and failed.
