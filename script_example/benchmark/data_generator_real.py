...
class MLPerfDatasetLoader:
    ...
    def __init__(self, cache_dir: str = "${REPO_ROOT}/benchmark/datasets"):
...
class RealKVCacheExtractor:
    ...
    def _extract_single(
        ...
        for block_idx in range(num_blocks):
            ...
            if sample.is_shared_prefix and block_idx < (len(tokens) // self.block_size) // 2:
...
class RealDataGenerator:
    ...
    def generate(
        ...
        output_dir: str = "${REPO_ROOT}/benchmark/data_real",
...
def main():
    ...
    parser.add_argument("--output", type=str,
                        default="${REPO_ROOT}/benchmark/data_real")
